...
DataLoadResult DataLoader::loadNext(DepthImage* depth_frame_ptr,
  ...
  // For the redwood dataset the depth and color cameras are the same, so just
  // copying over.
  auto result =
