...
def get_default_fuse_replica_binary_path() -> Path:
    """
    Return the path where the "fuse_replica" binary usually lives.
...
def get_dataset_name_from_dataset_root_path(dataset_root_path: Path) -> str:
    """
    Get the name of the replica dataset from a path to the dataset root folder.
...
def get_dataset_root_from_groundtruth_mesh_path(
    ...
    """
    return groundtruth_mesh_path.parent / get_dataset_name_from_groundtruth_mesh_path(
